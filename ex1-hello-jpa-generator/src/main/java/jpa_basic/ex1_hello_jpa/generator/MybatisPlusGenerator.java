package jpa_basic.ex1_hello_jpa.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "jpa_basic.ex1_hello_jpa";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/ex1-hello-jpa-model"),
        mapper("/ex1-hello-jpa-dao"),
        mapperxml("/ex1-hello-jpa-web"),
        service("/ex1-hello-jpa-service"),
        web("/ex1-hello-jpa-web"),
        ;
